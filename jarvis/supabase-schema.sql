...
CREATE TABLE episodes (
  ...
  importance INT DEFAULT 4 CHECK (importance BETWEEN 1 AND 10),
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- Seed: initial facts about Edu (edit to match reality)
...
-- Row Level Security (básico para Phase 0 — single user)
ALTER TABLE edu_memory ENABLE ROW LEVEL SECURITY;
ALTER TABLE episodes ENABLE ROW LEVEL SECURITY;
ALTER TABLE messages ENABLE ROW LEVEL SECURITY;

-- Service role bypasses RLS — frontend usa service key apenas no servidor
